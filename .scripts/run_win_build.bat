...
mamba.exe install "python=3.10" pip mamba conda-build conda-forge-ci-setup=4 rattler-build-conda-compat -c conda-forge --strict-channel-priority --yes
if !errorlevel! neq 0 exit /b !errorlevel!
echo Overriding conda-forge-ci-setup with local version
conda.exe uninstall --quiet --yes --force conda-forge-ci-setup=4 rattler-build-conda-compat
if !errorlevel! neq 0 exit /b !errorlevel!
