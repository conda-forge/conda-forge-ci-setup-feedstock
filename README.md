...
pixi add conda-forge-ci-setup
# for installing globally
pixi global install conda-forge-ci-setup
```
...
It is possible to list all of the versions of `conda-forge-ci-setup` available on your platform:
...
```
pixi search conda-forge-ci-setup --channel conda-forge
```
